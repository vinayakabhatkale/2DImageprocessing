...
: ${AMENT_CURRENT_PREFIX:="/root/ModProFT/src/install/modproft_adapter_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/modproft_adapter_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/modproft_adapter_description/environment/path.sh"
