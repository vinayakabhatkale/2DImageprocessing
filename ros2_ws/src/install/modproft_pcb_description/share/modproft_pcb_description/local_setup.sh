...
: ${AMENT_CURRENT_PREFIX:="/root/ModProFT/src/install/modproft_pcb_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/modproft_pcb_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/modproft_pcb_description/environment/path.sh"
