...
#include "rcontrol_msgs/action/move_joint.hpp"
#include "rcontrol_msgs/action/move_pose.hpp"
#include "rcontrol_msgs/action/move_cartesian.hpp"
#include "rclcpp/rclcpp.hpp"
...
public:
  ...
  using MoveJointAction = rcontrol_msgs::action::MoveJoint;
  using MovePoseAction = rcontrol_msgs::action::MovePose;
  using MoveCartesianAction = rcontrol_msgs::action::MoveCartesian;
